    ...
    <div className="about-container">
      <div className="about-banner">
        ...
        <span className="about-text01">
          <span>
            <span>
              אנחנו משפחה של אומנים שיוצרת מציית בסגנונוגת שונים אנחנו משפחה של
              אומנים שיוצרת מציית בסגנונוגת שונים אנחנו משפחה של אומנים שיוצרת
              מציית בסגנונוגת שונים
              <span
      ...
      <div className="about-gallery">
        <h3 className="about-text05">יצירות נבחרות</h3>
        <span className="about-text06">
          <br></br>
          <span>
            <span>
              מוזמנים לעיין וליצור קשר{" "}
              <span
                dangerouslySetInnerHTML={{
                  __html: " "
                }}
